...
La création du toponyme est détaillée plus haut "[Créer un toponyme](https://guide.mes-adresses.data.gouv.fr/creer-un-toponyme)". Par défaut, la position proposée est "segment", pour correspondre au "centre". Dans certaines situations, d’autres positions peuvent être précisées, comme sur cet exemple avec la position "entrée" qui correspond au départ d’un chemin de terre privé difficilement praticable.\
