---
title: "Outils pour vérifier les adresses"
---

- [L’explorateur de la Base Adresse Nationale](https://adresse.data.gouv.fr/carte-base-adresse-nationale)\*\
...
- [La page d’information des adresses par commune](https://adresse.data.gouv.fr/commune)\* \
...
- [L'explorateur FANTOIR](https://adresse.data.gouv.fr/outils/fantoir)\
...
- [La documentation sur le format Base Adresse Locale](/docs/documentation-generale/mettre-a-jour-sa-base-adresse-locale/le-format-base-adresse-locale/)\*\*\
...
- [Le validateur de Base Adresse Locale](https://adresse.data.gouv.fr/outils/validateur-bal)\*\*\
...
- [État de la Base Adresse Nationale par commune](https://www.data.gouv.fr/datasets/etat-de-la-base-adresse-nationale-par-commune)\*\*\
...
- [Le nombre de locaux adressables par communes](https://www.data.gouv.fr/datasets/nombre-de-locaux-adressables-par-communes)\*\*\
