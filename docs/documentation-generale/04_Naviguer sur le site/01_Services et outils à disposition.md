...
* Le Guide de l'éditeur en [format texte](https://guide.mes-adresses.data.gouv.fr/) ou en [PDF](https://adresse.data.gouv.fr/data/docs/guide-mes-adresses-v4.0.pdf)
