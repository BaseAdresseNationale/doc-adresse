...
### Faire savoir où télécharger les adresses officielles de la Base Adresse Nationale

Les adresses sont accessibles sous forme d’API et de fichiers depuis l’onglet "Données nationales" pour des usages massifs. D'autres utilisateurs sont intéressés par le fichier de la commune seulement. Les deux solutions sont proposées. Il est préférable de communiquer le lien vers les fichiers et non de les envoyer par mail.
