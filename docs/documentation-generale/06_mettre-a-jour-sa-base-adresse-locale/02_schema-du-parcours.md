...
* son **organisme de mutualisation** (EPCI, agence départementale) par moissonnage ou API de dépôt en ayant au préalable adopté la [Charte de la Base Adresse Locale](https://adresse.data.gouv.fr/bases-locales/charte) (organismes à but non lucratif).
