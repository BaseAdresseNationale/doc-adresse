---
title: "Diffuser la réglementation en matière de circulation routière"
---

Vous avez enregistré et publié vos adresses, vous souhaitez maintenant indiquer aux services de GPS la réglementation de circulation en vigueur sur votre commune ? Un service en ligne du Ministère de la Transition écologique, [DIALOG](https://dialog.beta.gouv.fr/), vous permet à la fois de rédiger vos arrêtés et de les diffuser à l'ensemble des opérateurs de navigation GPS (Google Map, Waze, Tomtom, Here, Apple map...).

<div align="center" data-full-width="false"><figure><img src="/img/documentation-generale/Capture site dialog.png" alt=""/><figcaption></figcaption></figure></div>
