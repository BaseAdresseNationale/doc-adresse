...
2. certification du compte à demander sur [cette page](https://www.data.gouv.fr/support/collectivite-territoriale/certification) ("J'ai une question" > L'utilisation de data.gouv.fr > Faire certifier son organisation") en indiquant le nom de l’organisation à certifier dans le corps du texte,
