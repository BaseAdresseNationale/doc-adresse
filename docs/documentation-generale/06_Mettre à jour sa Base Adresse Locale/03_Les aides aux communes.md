...
Les communes peuvent recevoir une aide au titre de la DETR (dotation d'équipement des territoires ruraux). La demande se fait à partir du portail [démarche simplifiées](https://www.demarches-simplifiees.fr/).
...
> **Voir notre article :**  [Les prestations pour la réalisation d’une Base Adresse Locale](04_Les%20prestations%20pour%20la%20réalisation%20d’une%20Base%20Adresse%20Locale.md)
...
Il existe également des solutions d’autocollants pour réutiliser les panneaux obsolètes, comme à [Chuzelles](https://adresse.data.gouv.fr/blog/chuzelles-modele-de-contribution-et-de-partage)

![](</img/documentation-generale/image (17).png>)
