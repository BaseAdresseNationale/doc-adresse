Une nouvelle dynamique est lancée sur la fabrique de l'adresse : un lieu, une
méthode et un petit format pour que chacun intervienne dans de bonnes
conditions et participe au partage des solutions.
...
* Le film de présentation de la Base Adresse Nationale ["Base Adresse Nationale, le film"](https://adresse.data.gouv.fr/blog/base-adresse-nationale-le-film)
* Le billet de blog [Adresse en région, un cheminement de terrain](https://adresse.data.gouv.fr/blog/adresse-en-region-un-cheminement-de-terrain)

**Les restitutions sur les pages suivantes >**
