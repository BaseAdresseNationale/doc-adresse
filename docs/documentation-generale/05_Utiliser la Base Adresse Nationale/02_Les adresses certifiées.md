...
Le champ **certification_commune** est un champ obligatoire du [format Base Adresse Locale 1.3](/docs/documentation-generale/Mettre%20%C3%A0%20jour%20sa%20Base%20Adresse%20Locale/Le%20format%20Base%20Adresse%20Locale) qui permet de renseigner le statut de certification. Une commune qui gère ses adresses sur son propre outil complète ce champ par des 0 lorsque l'adresse n'est pas certifiée ou 1 lorsqu'elle est certifiée.
