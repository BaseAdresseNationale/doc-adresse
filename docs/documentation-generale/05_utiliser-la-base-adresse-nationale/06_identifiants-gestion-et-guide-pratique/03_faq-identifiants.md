...
### · Format uuid_v4 : avez-vous étudié la possibilité d'utiliser des nano-id, plus compact et utilisables par des humains ? C'est le choix fait coté référentiel national des bâtiments.
...
### · Est-il prévu de faire disparaitre le champ cle_interop une fois les identifiants bien en place?

Le champ **cle_interop** a disparu depuis le format BAL 1.5

### · Le code Fantoir sera-t-il maintenu à l'avenir ?

Il est bien dans notre objectif de conserver dans les informations associées à l’adresse la clé de liaison avec le référentiel FANTOIR, devenu **code_TOPO**.
...
## · id_BAN uniquement pour les adresses certifiées ?
