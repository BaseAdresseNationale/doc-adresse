...
**Principe directeur de stabilité et perennité** : l'identifiant est affecté à l'objet pour toute la durée du cycle de vie de l'objet


* Primordial : après initialisation des ID, s’assurer pour les publications suivantes de **repartir de l’état validé précédent dans la BAN**. Attention aux conflits de BAL, notamment en cas de changement de mode de publication
...
* En cas de fusion de communes :
  - un nouvel identifiant de commune doit être associé à la commune nouvelle.
