            ...
            <div className="text-wrapper">
              ...
              <ul>
                ...
                <li>
                  ...
                  <div>
                    Présentant la Base Adresse Nationale, les formats d’adresse
                    ainsi que les services et outils accessibles sur le site.
                  </div>
                </li>
                <li>
                  <b>Une FAQ</b>
          ...
          <div>
            <div className="text-wrapper">
              ...
              <p>
                ...
                de gérer simplement vos adresses, de la constitution d’une Base
                Adresse Locale à sa mise à jour. Il est accessible sans
        ...
        <Section className="guide-section">
          <div>
            ...
            <div className="text-wrapper">
              ...
              <p>
                Les communes sont responsables de leurs adresses. Ce guide passe
                en revue les bonnes pratiques pour nommer, numéroter les voies
                et diffuser l’information en parfaite conformité avec les
                obligations légales et rien que les obligations légales.
              </p>
              <div className="buttons-wrapper">
                <Button
                  linkProps={{
